global.register(function (comvarSet) {
    var warrior = {
        ...
        initialize : function () {
            ...
            for (index = 0; index < length; index += 1) {
                if (index !== 4) {
                    if (typeof comvarSet[index] === 'number' &&
                        ...
                        if (comvarSet[index].slice(0, 2) === '00') {
                            newFrontIndexes.push(index);
                        }
            ...
            this.newFrontIndexes    = newFrontIndexes;
        },
        ...
        shoot : function (comvarSet) {
            ...
            if (this.frontIndexes.length &&
                ...
                if (this.newFrontIndexes.length) {
                    this.shoot1 = this.shoot2 = this.getRandomItemFromArray(this.newFrontIndexes);
                    this.shoot3 = this.getRandomItemFromArray(this.newFrontIndexes);
                } else {
                ...
                if (this.enemyIndexes.length === 1) {
                    ...
                    if (this.newFrontIndexes.length) {
                        this.shoot3 = this.getRandomItemFromArray(this.newFrontIndexes);
                    } else if (this.frontIndexes.length) {
                        this.shoot3 = this.getRandomItemFromArray(this.frontIndexes);
